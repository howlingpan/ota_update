    ...
    private void executeDownload() {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                dataDir = context.getApplicationInfo().dataDir + "/files/ota_update";
            } else {
                dataDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath();
            }
            //PREPARE URLS
